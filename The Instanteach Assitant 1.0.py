...
def done_checker(response_sheet):
   ...
   exist_check=os.path.isdir(('D:\All Docs\SWMM SCHOL\InstanTeach\Instanteachers\Cohort B\{}').format(email_notdone))#Check if teacher previously filled out form
   if exist_check==True:
   ...
   repeat_prompt=input('Repeat?(y/n)')#repeats for next entry entry
